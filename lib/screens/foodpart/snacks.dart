                ...
                return Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      var snack = snapshot.data?.docs[index];
                      var name = snack?['name'];
                      var kcal = snack?['kcal'];
                      var image =snack?['image'];
                      var desc = snack?['desc'];

                      return SnacksListViewItem(name: name , kcal: kcal, image: image,desc: desc,)
...
class SnacksListViewItem extends StatelessWidget {
