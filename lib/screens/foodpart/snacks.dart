...
class SnacksListViewItem extends StatefulWidget {
  const SnacksListViewItem({
    Key? key,
    required this.id,
    required this.name,
    required this.desc,
  ...
  @override
  _SnacksListViewItemState createState() => _SnacksListViewItemState();
}

class _SnacksListViewItemState extends State<SnacksListViewItem> {
